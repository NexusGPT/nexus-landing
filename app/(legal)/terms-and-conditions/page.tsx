...
export const metadata: Metadata = createPageMetadata({
  ...
  description: "Nexus Terms of Service - Read our terms and conditions for using the Nexus platform.",
        ...
        dangerouslySetInnerHTML={{
          __html: escapeJsonLd(
            breadcrumbSchema([
              ...
              { name: "Terms and Conditions", item: "https://agent.nexus/terms-and-conditions" },
            ])
          ),
        }}
      />
        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-12">
            ...
            <p className="text-nexus-grey-medium font-sans text-base leading-relaxed mb-4">
              We are <strong>NEXUS ENTERPRISES</strong>, doing business as nexusGPT ("Company," "we," "us," "our"), a company registered in Delaware, United States at 251 Little Falls Drive, 19808 Wilmington, Delaware.
            </p>
            <p className="text-nexus-grey-medium font-sans text-base leading-relaxed mb-4">
              We operate the website https://gpt.nexus (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
            </p>
            <p className="text-nexus-grey-medium font-sans text-base leading-relaxed mb-4">
              You can contact us by phone at +32468085206, email at{" "}
              <a href="mailto:contact@gpt.nexus" className="text-nexus-orange hover:underline">
                contact@gpt.nexus
              </a>
              , or by mail to 251 Little Falls Drive, 19808 Wilmington, Delaware, United States.
            </p>
            <p className="text-nexus-grey-medium font-sans text-base leading-relaxed mb-4">
              These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and NEXUS ENTERPRISES, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong>
            </p>
            <p className="text-nexus-grey-medium font-sans text-base leading-relaxed mb-4">
              We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by Contact@gpt.nexus, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.
            </p>
            <p className="text-nexus-grey-medium font-sans text-base leading-relaxed mb-4">
          ...
          <section className="mb-12">
            ...
            <p className="text-nexus-grey-medium font-sans text-base leading-relaxed mb-6">
              We have the right, in our sole and absolute discretion, (1) to edit, redact, or otherwise change any Contributions; (2) to re-cize any Contributions to place them in more appropriate locations on the Services; and (3) to pre-screen or delete any Contributions at any time and for any reason, without notice. We have no obligation to monitor your Contributions.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-nexus-grey-medium font-sans text-base leading-relaxed mb-6">
              ...
              <Link href="/privacy-policy" className="text-nexus-orange hover:underline">
                HTTPS://GPT.NEXUS/PRIVACY-POLICY
              </Link>
          ...
          <section className="mb-12">
            ...
            <p className="text-nexus-grey-medium font-sans text-base leading-relaxed mb-6">
              These Legal Terms are governed by and interpreted following the laws of the State of Delaware, United States, without regard to its conflict of law provisions. NEXUS ENTERPRISES and yourself both agree to submit to the exclusive jurisdiction of the courts located in Delaware, United States, for the resolution of any disputes arising out of or relating to these Legal Terms.
            </p>
          </section>
