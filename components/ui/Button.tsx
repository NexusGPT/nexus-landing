...
export default function Button({
  ...
  const baseClasses = "font-mono text-[13px] uppercase tracking-wide px-4 lg:px-6 py-2 lg:py-3 transition-all duration-300 flex items-center justify-center gap-2 whitespace-nowrap border border-solid font-thin";
