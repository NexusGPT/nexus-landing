...
function FooterLink({ href, children, newTab = false }: { href: string; children: React.ReactNode; newTab?: boolean }) {
  return (
    <Link
      ...
      className="group relative font-sans text-base transition-opacity w-fit"
    >
      {children}
      <span className="absolute -bottom-1 left-0 w-0 h-px bg-nexus-black transition-all duration-500 [transition-timing-function:cubic-bezier(1,0.17,0.16,0.88)] group-hover:w-full"></span>
    </Link>
  );
}
...
export default function Footer() {
  return (
    <footer className="bg-nexus-white py-20 px-6 lg:px-16 text-nexus-grey-medium">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between gap-16">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-0">
              <p className="font-mono text-xs uppercase text-nexus-black lg:text-left">
                Certifications
              </p>
          ...
          <div className="flex flex-col lg:flex-row gap-[125px] ">
            ...
            <div className="flex flex-col gap-6">
              <p className="font-mono text-sm uppercase tracking-wider text-left">
                Resources
              </p>
            ...
            <div className="lg:hidden flex flex-col text-nexus-grey-medium font-sans">
              <p>Nexus Enterprises, Inc.</p>
              <p>251 Little Falls Drive</p>
              <p>19808 Wilmington, Delaware</p>
            </div>
