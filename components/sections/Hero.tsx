...
export default function Hero() {
  return (
    <div className="relative overflow-hidden w-full h-auto min-h-[550px] sm:min-h-[600px]">
      {/* Blend Mode Example - Small demo at top */}
      <HeroBackground />
      <section className="flex items-center min-h-[550px] sm:min-h-[600px] lg:min-h-[800px] px-6 sm:px-8 lg:px-20 relative overflow-hidden py-8 sm:py-12 lg:py-0">
        <div className="max-w-[1440px] mx-auto w-full flex items-center">
          ...
          <div className="col-span-1 z-10 lg:col-span-7 flex flex-col">
            ...
            {/* Main Headline */}
            <h1
              className="text-3xl sm:text-4xl lg:text-5xl xl:text-[90px] mt-3 sm:mt-4 font-pp-fragment font-normal leading-[1.1] tracking-tight bg-clip-text text-transparent"
              style={{
                backgroundImage:
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 mt-6 sm:mt-8 lg:mt-10">
              <Button
                variant="primary"
          ...
          <div className="col-span-1 lg:col-span-5 bg-transparent relative h-[300px] sm:h-[400px] lg:h-[600px] xl:h-[844px] flex items-center justify-center mt-6 lg:mt-0">
            <div
              className="w-full h-full max-w-[280px] sm:max-w-[390px] lg:max-w-full bg-transparent"
