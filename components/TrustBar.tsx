...
export default function TrustBar() {
  ...
  return (
    <section className="pb-12 md:pb-16">
      <div className="flex flex-col items-center gap-8 pb-16 max-w-[1440px] mx-auto px-8 md:px-20">
        {/* Label */}
      ...
      <div className="w-full overflow-hidden relative">
        {/* Left fade gradient */}
        <div className="absolute left-0 top-0 bottom-0 w-64 bg-[linear-gradient(to_right,white_0%,white_30%,transparent_100%)] z-10 pointer-events-none"></div>
        
        {/* Right fade gradient */}
        <div className="absolute right-0 top-0 bottom-0 w-64 bg-[linear-gradient(to_left,white_0%,white_30%,transparent_100%)] z-10 pointer-events-none"></div>
